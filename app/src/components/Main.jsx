...
export default function Main({ network, voteAccount }) {
  ...
  useEffect(() => {
    ...
    async function getVotes() {
      ...
      try {
        ...
        setVotes({
          republicians: parseInt(account.republicians.toString()),
          democrats: parseInt(account.democrats.toString()),
        });
      } catch (error) {
  ...
  // Vote for either republicians or democrats. Poll for updated vote count on completion
      ...
      <Box flex="1 0 auto">
        ...
        <Container>
          <Grid container spacing={3}>
            ...
            <Grid item xs={6}>
              <VoteOption side="republicians" handleVote={handleVote} />
            </Grid>
            <Grid item xs={6}>
              <VoteOption side="democrats" handleVote={handleVote} />
            </Grid>
            <Grid item xs={12}>
